...
namespace HT16K33_duinotech {
    ...
    function writeDisplay() {
        ...
        for (let i = 0; i < 4; i++) {
            let p =  i;// i ^ 2;  //new mapped position
